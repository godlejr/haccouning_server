...
public class SlipHeaderDao {
	...
	private List<SlipDetailDao> slipDetails;
	public SlipHeaderDao() {
		super();
	...
	public List<SlipDetailDao> getSlipDetails() {
		return slipDetails;
	}

	public void setSlipDetails(List<SlipDetailDao> slipDetails) {
