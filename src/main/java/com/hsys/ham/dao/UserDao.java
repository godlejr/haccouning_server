...
public class UserDao extends BaseDao {
	...
	public void setCdate(String cdate) {
		super.setCdate(cdate);
	}

	@Override
	public String getUdate() {
		return super.getUdate();
	}
	...
	public String toString() {
		return "User{" + "compCd='" + compCd + '\'' + ", empNo='" + empNo + '\'' + ", loginId='" + loginId + '\''
				+ ", loginPw='" + loginPw + '\'' + ", compNm='" + compNm + '\'' + ", empNm='" + empNm + '\''
				+ ", startDate='" + startDate + '\'' + ", endDate='" + endDate + '\'' + ", siteCd='" + siteCd + '\''
				+ ", siteNm='" + siteNm + '\'' + ", deptCd='" + deptCd + '\'' + ", deptNm='" + deptNm + '\''
				+ ", erpId='" + erpId + '\'' + ", erpVendorId='" + erpVendorId + '\'' + ", accessToken='" + accessToken
				+ '\'' + ", deviceId='" + deviceId + '\'' + ", loginStatus=" + loginStatus + '}';
	}
